...
async def play(client: Client, message):
  ...
  user_id = message.from_user.id if message.from_user else "m_2_r_k"
  message_id = message.id 
  gr = await get_group(bot_username)
  ch = await get_channel(bot_username)
  button = [[InlineKeyboardButton(text="𓏺 َِ𝖤َِ𝗇َِ𝖣 .", callback_data=f"stop"), InlineKeyboardButton(text="𓏺 َِ𝖱َِ𝖾َِ𝖲َِ𝗎َِ𝖬َِ𝖾 .", callback_data=f"resume"), InlineKeyboardButton(text="𓏺 َِ𝖯َِ𝖺َِ𝖴َِ𝗌َِ𝖤 .", callback_data=f"pause")], [InlineKeyboardButton(text="𓏺 َِ𝗖َِ𝗵َِ𝗔َِ𝗻َِ𝗡َِ𝗲َِ𝗟 .", url=f"https://t.me/JX_JK"), InlineKeyboardButton(text="𓏺 َِ𝗚َِ𝗿َِ𝗢َِ𝘂َِ𝗣 .", url=f"https://t.me/NE_GJ")], [InlineKeyboardButton(text=f"{OWNER_NAME}", url=f"https://t.me/m_2_r_k")], [InlineKeyboardButton(text="اضف البوت الي مجموعتك او قناتك ⚡", url=f"https://t.me/{bot_username}?startgroup=True")]]
     ...
     if await is_served_call(client, message.chat.id):
         ...
         if message.from_user:
          if message.from_user.photo:
           ...
           ahmed = await client.get_chat("m_2_r_k")
