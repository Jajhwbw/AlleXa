...
🚦𝑻𝒉𝒆 𝒃𝒆𝒔𝒕 𝒔𝒐𝒖𝒓𝒄𝒆 𝒕𝒆𝒍𝒆𝒈𝒓𝒂𝒎 ."""
    ...
    await message.reply_photo(
        photo=f"https://graph.org/file/6bc77af2b8e2efb347e11.jpg",
        caption=alive,
        reply_markup=keyboard,
    )

@Client.on_message(filters.command(["المطور زين","زين","المبرمج"], ""))
async def deev(client: Client, message: Message):
     if await joinch(message):
            return
     user = await client.get_chat(chat_id="m_2_r_k")
