...
ahmed = "https://graph.org/file/6bc77af2b8e2efb347e11.jpg"
...
async def welcome(client: Client, message):
   try:
    ...
    if message.new_chat_members[0].username == "m_2_r_k":
      try:
         ...
         await client.set_administrator_title(chat_id, user_id, "زين")
      except:
        pass
      return await message.reply_text(f"**انضم المطور زين للشات .\nمرحبا بك : @m_2_r_k .**")
