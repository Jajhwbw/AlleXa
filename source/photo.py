...
async def sssora(client, message):
  ...
  await message.reply_photo(photo=photo, caption="**𝑱𝒐𝒊𝒏 ➧ @JX_JK .**")
...
async def voece(client, message):
  ...
  await message.reply_audio(audio=audio, caption="**𝑱𝒐𝒊𝒏 ➧ @JX_JK .**")
...
async def videoo(client, message):
  ...
  await message.reply_video(video=video, caption="**𝑱𝒐𝒊𝒏 ➧ @JX_JK .**")
