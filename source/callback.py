...
[InlineKeyboardButton("صاحب السورس 🧑‍✈️", url=f"https://t.me/m_2_r_k")],
[InlineKeyboardButton("طريقة التشغيل 🧠", callback_data="bcmds"),InlineKeyboardButton("طريقة التفعيل 🦸", callback_data="bhowtouse")],
[InlineKeyboardButton("جروب البوت 🤖", url=f"https://t.me/NE_GJ"),InlineKeyboardButton("قناه التحديثات 🐉", url=f"https://t.me/JX_JK")],
...
ᴘᴏᴡᴇʀᴇᴅ ʙʏ [{OWNER_NAME}]""",
        ...
        reply_markup=InlineKeyboardMarkup([
[InlineKeyboardButton("The owner of the source 🧑‍✈️", url=f"https://t.me/m_2_r_k")],
...
[InlineKeyboardButton("Bot Group 🤖", url=f"https://t.me/NE_GJ"),InlineKeyboardButton("Channel Updates 🐉", url=f"https://t.me/JX_JK")],
[InlineKeyboardButton(f"{devname}", user_id=f"{dev}")],
...
💡 ɪғ ʏᴏụ ʜᴀᴠᴇ ᴀ ғᴏʟʟᴏᴡ-ụᴘ ǫụᴇѕᴛɪᴏɴѕ ᴀʙᴏụᴛ ᴛʜɪѕ ʙᴏᴛ, ʏᴏụ ᴄᴀɴ ᴛᴇʟʟ ɪᴛ ᴏɴ ᴍʏ ѕụᴘᴘᴏʀᴛ ᴄʜᴀᴛ ʜᴇʀᴇ: @NE_GJ
