...
async def source(c: Client, m):
  mostafa ="""
╭──── • ◈ • ────╮
么 [ ⧛ َ𝗝َ َ𝗢َ ٍ𝗞َ ׀ مــ ـٰٖمـوِٰلٰ ׀ جـِوڪَ ׀ ⧚ ](t.me/G_O_OZ).
么  [ ⤹- ᗰᖇK ┊ ٰᶠᶸᶜᵏᵧₒᵤ ⤾ᯤ̸. .](t.me/m_2_r_k).
╰──── • ◈ • ────╯
🚦 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼 .
"""
  await m.reply_video("https://t.me/UIU_II/650",caption=mostafa,quote=True)
